# Generated by Django 4.2.8 on 2024-06-14 10:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chat_messages', to='websockets.chatgroup')),
            ],
            options={
                'ordering': ['-created'],
            },
